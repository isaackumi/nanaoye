		...
		if ($product_list) {
			...
			foreach ($product_list as $product) {
				...
				echo " 
				    ...
				    <div class='productprice'><div class='pull-right'><a href='#' class='btn btn-danger btn-sm' role='button'>Add to Cart</a></div><div class='pricetext'>$product[product_price]</div></div>
					</div>
                 ";
