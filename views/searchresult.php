...
<body>
	...
	<?php
		...
		$sterm = isset($_GET['search'])?$_GET['searcht']:null;
			//run the function to return all customer list
		$product_list = search_a_product_z($sterm);
		...
		if ($product_list) {
			...
			foreach ($product_list as $product) {
				...
				echo ' 
				    ...
				    <div class="productprice"><div class="pull-right"><a href="../actions/add_to_cart.php?pid=$product_id&cid=$cid" class="btn btn-danger btn-sm" role="button">Add to Cart</a></div><div class="pricetext">'.$price.'</div></div>
