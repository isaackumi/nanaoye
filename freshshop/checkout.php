        ...
        <div class="container">
            <div class="row new-account-login">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 collapse review-form-box" id="formRegister" action="">
                        <div class="form-row">
                            <!-- <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 mb-3">
                        ...
                        <form class="needs-validation" id="">
                            ...
                            <div class="row">
                                <div class="col-md-5 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address2" placeholder="" name="country">
                                    
                                    <!-- <div class="invalid-feedback"> Please select a valid country. </div> -->
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="state">State *</label>
                                    <input type="text" class="form-control" id="address2" placeholder="" name="state">
                                    <input type="hidden" class="form-control" id="email" value="<?= $email; ?>" name="state">
                                    <input type="hidden" class="form-control" id="amount" value="<?= getTotalItemAmountInCart() ?>" name="state">
                    ...
                    <input type="hidden" class="form-control" id="amount" value="<?= getTotalItemAmountInCart() ?>" name="amount">
                                    

                    <div class="col-12 d-flex shopping-box"> 
                                <input type="submit"  class="ml-auto btn hvr-hover" value="Order"> 
                            </div>
                </form>
                </div>
                <div class="col-sm-6 col-lg-6 mb-3">
                    <!-- <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="order-box">
                                ...
                                <div class="d-flex">
                                    <h4>Sub Total</h4>
                                    <div class="ml-auto font-weight-bold">  GH¢ <?= getTotalItemAmountInCart() ?>.00 </div>
                                </div>
                                <div class="d-flex">
                                    <h4>Discount</h4>
                                    <div class="ml-auto font-weight-bold"> GH¢ 0.00 </div>
                                </div>
                                <hr class="my-1">
                                <div class="d-flex">
                                ...
                                <div class="d-flex gr-total">
                                    <h5>Grand Total</h5>
                                    <div class="ml-auto h5"> GH¢ <?= getTotalItemAmountInCart() ?>.00  </div>
                                </div>
                                <hr> </div>
                        </div>
                        <input type="hidden" value='<?= getTotalItemAmountInCart() ?>' id="amount">
                        <div id="smart-button-container">
      <div style="text-align: center;">
        <div id="paypal-button-container"></div>
      </div>
    </div>
                        <div class="col-12 d-flex shopping-box"> <button type="button"  onclick="initPayPalButton()" class="ml-auto btn hvr-hover">Place Order</button> </div>
                    </div>
                </div>
            </div>
